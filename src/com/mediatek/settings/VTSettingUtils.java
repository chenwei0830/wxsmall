...
public class VTSettingUtils{
    ...
    private static final VTSettingUtils mVTSettingUtils = new VTSettingUtils();
    ...
    public void updateVTEngineerModeValues() {
        ...
        if (DBGEM) {
            log(" - mVTEngineerModeValues.config_video_channel_reverse = "+mVTEngineerModeValues.config_video_channel_reverse);
        }
        if (DBGEM) {
            log(" - mVTEngineerModeValues.config_multiplex_level = "+mVTEngineerModeValues.config_multiplex_level);
        }
        if (DBGEM) {
            log(" - mVTEngineerModeValues.config_video_codec_preference = "+mVTEngineerModeValues.config_video_codec_preference);
        }
        if (DBGEM) {
