...
public final class ExtensionManager {
    ...
    /**
     * Get PhoneAppBroadcastReceiver extension object
     * @return PhoneAppBroadcastReceiver extension object
     */
    public PhoneAppBroadcastReceiverExtension getPhoneAppBroadcastReceiverExtension() {
        log("PhoneAppBroadcastReceiverExtension()");
        return mPhonePluginExtContainer.getPhoneAppBroadcastReceiverExtension();
    }
    ...
    private void initContainerByPlugin() {
        PluginManager<IPhonePlugin> pm = PluginManager.<IPhonePlugin>create(
                PhoneApp.getInstance(), IPhonePlugin.class.getName());
        try {
