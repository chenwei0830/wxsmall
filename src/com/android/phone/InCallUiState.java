...
public class InCallUiState {
    ...
    InCallScreenMode lastInCallScreenMode = InCallScreenMode.UNDEFINED;
    ...
    static int mLastInCallScreenStatus;
    
    static boolean isNormalInCallScreenState() {
        return mLastInCallScreenStatus == INCALLSCREEN_NOT_EXIT_NORMAL;
    }
