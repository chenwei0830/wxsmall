...
public class RespondViaSmsManager {
    ...
    private void sendText(String phoneNumber, String message) {
        ...
        if(FeatureOption.MTK_GEMINI_SUPPORT)
            intent.putExtra(Phone.GEMINI_SIM_ID_KEY, getSendTextSimId());
        /**
    ...
    protected boolean shouldDismissInCallScreen() {
        ...
        return !(cm.hasActiveFgCall() || cm.hasActiveBgCall() || cm.getState() == Phone.State.RINGING);
    }
}
