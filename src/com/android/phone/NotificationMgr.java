...
public class NotificationMgr implements CallerInfoAsyncQuery.OnQueryCompleteListener{
	   ...
	   String action = intent.getAction();
           if(action.equals(INTENTFORSIM1)||action.equals(INTENTFORSIM2)){
                 ...
                 // Use NetworkSetting to handle the selection intent
                  simIntent.setComponent(new ComponentName(Constants.PHONE_PACKAGE, NetworkSetting.class.getName()));
    ...
    /* package */ void notifyMissedCall(
            String name, String number, String type, Drawable photo, Bitmap photoIcon, long date, int callVideo) {
        ...
        NotificationPlus notiPlus = new NotificationPlus.Builder(mContext)
                ...
                .setPositiveButton(mContext.getString(R.string.ok), calllogIntentPlus)
                .create();
    ...
    public void updateSpeakerNotification() {
        ...
        boolean showNotification =
                (state == Phone.State.OFFHOOK) && audioManager.isSpeakerphoneOn();
    ...
    private void updateInCallNotification(boolean allowFullScreenIntent) {
        ...
        Intent inCallIntent = PhoneApp.createInCallIntent();
...
/*            if (TextUtils.isEmpty(vmNumber)) {
        ...
        if (visible) {
            ...
            if (showExpandedNotification) {
                ...
                notification.setLatestEventInfo(
                        ...
                        // !!!! Need to check whether this below code need modify
    ...
    private void showNetworkSelection(String operator, int simId) {
        ...
        // Use NetworkSetting to handle the selection intent
        intent.setComponent(new ComponentName(Constants.PHONE_PACKAGE, NetworkSetting.class.getName()));
        intent.putExtra(Phone.GEMINI_SIM_ID_KEY, simId);
    ...
    private void cancelNetworkSelection(int simId) {
        ...
        if (simId == Phone.GEMINI_SIM_1) {
            ...
            mNotificationManager.cancel(SELECTED_OPERATOR_FAIL_NOTIFICATION_2);
        }
    }
